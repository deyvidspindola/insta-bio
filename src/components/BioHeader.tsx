  ...
  return (
    <header className="mb-10 flex animate-fade-up flex-col items-center text-center">
      ...
      <a
        ...
        className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-border bg-card/70 px-3.5 py-1.5 text-xs font-medium text-foreground/85 backdrop-blur-md transition-colors hover:border-primary/50 hover:text-foreground"
      >
